...
export type StoreCalendarEventsAllCalendarFragmentFragment = { uid: string, location?: string | null, start: string | Date, end: string | Date, capacity: number, forWorkshop?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forTalk?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forFusion?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forPanel?: { uid: string, name: string, description: string, reservation: number, companies: Array<{ uid: string, brandName: string }> } | null, companies?: Array<{ uid: string, brandName: string, rasterLogo?: { fullUrl: string, thumbUrl: string } | null }> | null } & { ' $fragmentName'?: 'StoreCalendarEventsAllCalendarFragmentFragment' };

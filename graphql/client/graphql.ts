...
export type Frag_InternshipFragment = { uid: string, position: string, competencies?: string | null, description: string, workingPeriodStart: string | Date, workingPeriodEnd: string | Date, url?: string | null, duration?: string | null, company?: { uid: string, brandName: string, rasterLogo?: { fullUrl: string, thumbUrl: string } | null } | null } & { ' $fragmentName'?: 'Frag_InternshipFragment' };

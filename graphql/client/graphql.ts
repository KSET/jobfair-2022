...
export type PageProfileMeCompanyScansListDataQuery = { scannedUsers: Array<{ note?: string | null, isStarred: boolean, scannedAt: string | Date, user?: { uid: string, name: string, email: string, phone: string, resume?: { cv?: { url: string } | null } | null } | null }> };

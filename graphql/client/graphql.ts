...
export type AdminCompanyApplicationsQuery = { industries: Array<{ name: string }>, talkCategories: Array<{ name: string }>, booths: Array<{ key?: string | null, name: string }>, companyApplications?: Array<{ wantsCocktail: boolean, wantsPanel: boolean, booth?: string | null, talk?: { language: string, titleEn: string, category: { name: string } } | null, cocktail?: { name: string, type: { type: string } } | null, workshop?: { language: string, titleEn: string } | null, forCompany?: { uid: string, brandName: string, legalName: string, industry?: { name: string } | null } | null, forSeason?: { uid: string } | null }> | null };

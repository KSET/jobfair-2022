...
export type ApplicationFusion = {
  _count?: Maybe<ApplicationFusionCount>;
  category?: Maybe<ApplicationTalkCategory>;
  createdAt: Scalars['DateTimeISO']['output'];
...
export type ApplicationFusionCount = {
  presenters: Scalars['Int']['output'];
};


export type ApplicationFusionCountPresentersArgs = {
  where?: InputMaybe<ApplicationPresenterWhereInput>;
};

export type ApplicationFusionNullableRelationFilter = {
  is?: InputMaybe<ApplicationFusionWhereInput>;
  isNot?: InputMaybe<ApplicationFusionWhereInput>;
};

export type ApplicationFusionOrderByWithRelationInput = {
...
export type ApplicationFusionWhereInput = {
  AND?: InputMaybe<Array<ApplicationFusionWhereInput>>;
  NOT?: InputMaybe<Array<ApplicationFusionWhereInput>>;
  OR?: InputMaybe<Array<ApplicationFusionWhereInput>>;
...
export type ApplicationInternshipForApplicationIdPositionWorkingPeriodStartWorkingPeriodEndCompoundUniqueInput = {
  forApplicationId: Scalars['Int']['input'];
  position: Scalars['String']['input'];
  workingPeriodEnd: Scalars['DateTimeISO']['input'];
  workingPeriodStart: Scalars['DateTimeISO']['input'];
};

export type ApplicationInternshipListRelationFilter = {
  every?: InputMaybe<ApplicationInternshipWhereInput>;
  none?: InputMaybe<ApplicationInternshipWhereInput>;
  some?: InputMaybe<ApplicationInternshipWhereInput>;
};

export type ApplicationInternshipOrderByRelationAggregateInput = {
  _count?: InputMaybe<SortOrder>;
};

export type ApplicationInternshipOrderByWithRelationInput = {
  competencies?: InputMaybe<SortOrderInput>;
  description?: InputMaybe<SortOrder>;
  duration?: InputMaybe<SortOrderInput>;
  externalCompany?: InputMaybe<SortOrderInput>;
  places?: InputMaybe<SortOrderInput>;
  position?: InputMaybe<SortOrder>;
  signed?: InputMaybe<SortOrderInput>;
...
export type ApplicationInternshipWhereInput = {
  ...
  competencies?: InputMaybe<StringNullableFilter>;
  description?: InputMaybe<StringFilter>;
  duration?: InputMaybe<StringNullableFilter>;
  externalCompany?: InputMaybe<StringNullableFilter>;
  places?: InputMaybe<IntNullableFilter>;
  position?: InputMaybe<StringFilter>;
  signed?: InputMaybe<BoolNullableFilter>;
...
export type ApplicationInternshipWhereUniqueInput = {
  ...
  duration?: InputMaybe<StringNullableFilter>;
  externalCompany?: InputMaybe<StringNullableFilter>;
  forApplicationId_position_workingPeriodStart_workingPeriodEnd?: InputMaybe<ApplicationInternshipForApplicationIdPositionWorkingPeriodStartWorkingPeriodEndCompoundUniqueInput>;
  places?: InputMaybe<IntNullableFilter>;
  position?: InputMaybe<StringFilter>;
  signed?: InputMaybe<BoolNullableFilter>;
  url?: InputMaybe<StringNullableFilter>;
...
export type ApplicationPresenterCountForFusionsArgs = {
  where?: InputMaybe<ApplicationFusionWhereInput>;
};
...
export type ApplicationQuestNullableRelationFilter = {
  is?: InputMaybe<ApplicationQuestWhereInput>;
  isNot?: InputMaybe<ApplicationQuestWhereInput>;
};

export type ApplicationQuestOrderByWithRelationInput = {
  prize?: InputMaybe<SortOrder>;
};

export type ApplicationQuestWhereInput = {
  AND?: InputMaybe<Array<ApplicationQuestWhereInput>>;
  NOT?: InputMaybe<Array<ApplicationQuestWhereInput>>;
  OR?: InputMaybe<Array<ApplicationQuestWhereInput>>;
...
export type ApplicationTalkCategoryCount = {
  fusions: Scalars['Int']['output'];
  talks: Scalars['Int']['output'];
};


export type ApplicationTalkCategoryCountFusionsArgs = {
  where?: InputMaybe<ApplicationFusionWhereInput>;
};
...
export type CalendarItem = {
  ...
  forFusion?: Maybe<ApplicationFusion>;
  forOtherContent?: Maybe<OtherContent>;
...
export type Company = {
  ...
  signatories: Array<CompanySignatory>;
  uid: Scalars['String']['output'];
  updatedAt: Scalars['DateTimeISO']['output'];
...
export type CompanyApplication = {
  ...
  wantsQuest: Scalars['Boolean']['output'];
...
export type CompanyApplicationApproval = {
  ...
  fusionParticipants: Scalars['Int']['output'];
  logoHidden: Scalars['Boolean']['output'];
  panel: Scalars['Boolean']['output'];
  quest: Scalars['Boolean']['output'];
...
export type CompanyApplicationApprovedEditInput = {
  ...
  quest?: InputMaybe<QuestChooseInput>;
...
export type CompanyApplicationCount = {
  internships: Scalars['Int']['output'];
  panelParticipants: Scalars['Int']['output'];
};


export type CompanyApplicationCountInternshipsArgs = {
...
export type CompanyApplicationCreateInput = {
  ...
  fusion?: InputMaybe<FusionCreateInput>;
  quest?: InputMaybe<QuestChooseInput>;
  ...
  wantsQuest: Scalars['Boolean']['input'];
...
export type CompanyApplicationOrderByWithRelationInput = {
  ...
  forSeason?: InputMaybe<SeasonOrderByWithRelationInput>;
  fusion?: InputMaybe<ApplicationFusionOrderByWithRelationInput>;
  internships?: InputMaybe<ApplicationInternshipOrderByRelationAggregateInput>;
...
export type CompanyCountSignatoriesArgs = {
  where?: InputMaybe<CompanySignatoryWhereInput>;
};
...
export type CompanyPanel = {
  ...
  companiesWithPanelists: Array<PanelCompanyEntry>;
  description: Scalars['String']['output'];
  event?: Maybe<CalendarItem>;
  name: Scalars['String']['output'];
  reservation: Scalars['Float']['output'];
...
export type CompanyScanUserQrRefineData = {
  cvSaved?: InputMaybe<Scalars['Boolean']['input']>;
  isStarred?: InputMaybe<Scalars['Boolean']['input']>;
  note?: InputMaybe<Scalars['String']['input']>;
  questEntered?: InputMaybe<Scalars['Boolean']['input']>;
};

export type CompanyScanUserQrResponse = {
  alreadyScanned: Scalars['Boolean']['output'];
  companyWantsQuest: Scalars['Boolean']['output'];
  cvSaved: Scalars['Boolean']['output'];
  deleted: Scalars['Boolean']['output'];
  error?: Maybe<Scalars['String']['output']>;
  isStarred?: Maybe<Scalars['Boolean']['output']>;
  note?: Maybe<Scalars['String']['output']>;
  questEntered: Scalars['Boolean']['output'];
  user?: Maybe<User>;
};
...
export type CompanySignatoryCreateInput = {
  fullName: Scalars['String']['input'];
  function: Scalars['String']['input'];
};

export type CompanySignatoryWhereInput = {
  AND?: InputMaybe<Array<CompanySignatoryWhereInput>>;
  NOT?: InputMaybe<Array<CompanySignatoryWhereInput>>;
  OR?: InputMaybe<Array<CompanySignatoryWhereInput>>;
...
export type FusionsCreateInput = {
  category: Scalars['String']['input'];
  descriptionEn: Scalars['String']['input'];
  descriptionHr: Scalars['String']['input'];
  language: Scalars['String']['input'];
...
export type ImageCountOtherContentPresenterArgs = {
  where?: InputMaybe<OtherContentPresenterWhereInput>;
};
...
export type LinkUnmatchedInternshipInput = {
...
export type Mutation = {
  ...
  linkUnmatchedInternship: ApplicationInternship;
  login: AuthResponse;
  ...
  syncSummerInternships: SyncResult;
  ...
  updateOtherContent?: Maybe<OtherContent>;
...
export type MutationDeleteOtherContentArgs = {
  uid: Scalars['String']['input'];
};
...
export type MutationLinkUnmatchedInternshipArgs = {
  input: LinkUnmatchedInternshipInput;
};
...
export type MutationSyncSummerInternshipsArgs = {
  season: Scalars['String']['input'];
};
...
export type MutationUpdateOtherContentArgs = {
  input: OtherContentUpdateInput;
};
...
export type OtherContent = {
  _count?: Maybe<OtherContentCount>;
  descriptionEn: Scalars['String']['output'];
  descriptionHr: Scalars['String']['output'];
  event?: Maybe<CalendarItem>;
  nameEn: Scalars['String']['output'];
  nameHr: Scalars['String']['output'];
  participants: Array<OtherContentPresenter>;
  reservation: Scalars['Float']['output'];
  subtype: Scalars['String']['output'];
  uid: Scalars['String']['output'];
};

export type OtherContentCount = {
  participants: Scalars['Int']['output'];
};


export type OtherContentCountParticipantsArgs = {
  where?: InputMaybe<OtherContentPresenterWhereInput>;
};

export type OtherContentPresenter = {
  bioEn: Scalars['String']['output'];
  bioHr: Scalars['String']['output'];
  firstName: Scalars['String']['output'];
...
export type OtherContentPresenterInput = {
...
export type OtherContentPresenterListRelationFilter = {
  every?: InputMaybe<OtherContentPresenterWhereInput>;
  none?: InputMaybe<OtherContentPresenterWhereInput>;
  some?: InputMaybe<OtherContentPresenterWhereInput>;
};

export type OtherContentPresenterWhereInput = {
  AND?: InputMaybe<Array<OtherContentPresenterWhereInput>>;
  NOT?: InputMaybe<Array<OtherContentPresenterWhereInput>>;
  OR?: InputMaybe<Array<OtherContentPresenterWhereInput>>;
  bioEn?: InputMaybe<StringFilter>;
  bioHr?: InputMaybe<StringFilter>;
  firstName?: InputMaybe<StringFilter>;
  forContent?: InputMaybe<OtherContentRelationFilter>;
  forContentId?: InputMaybe<IntFilter>;
  id?: InputMaybe<IntFilter>;
  lastName?: InputMaybe<StringFilter>;
  photo?: InputMaybe<ImageNullableRelationFilter>;
  photoId?: InputMaybe<IntNullableFilter>;
};

export type OtherContentRelationFilter = {
  is?: InputMaybe<OtherContentWhereInput>;
  isNot?: InputMaybe<OtherContentWhereInput>;
};

export type OtherContentUpdateInput = {
  descriptionEn: Scalars['String']['input'];
  descriptionHr: Scalars['String']['input'];
  nameEn: Scalars['String']['input'];
  nameHr: Scalars['String']['input'];
  participants?: InputMaybe<Array<OtherContentPresenterInput>>;
  season: Scalars['String']['input'];
  subtype: Scalars['String']['input'];
  uid?: InputMaybe<Scalars['String']['input']>;
};

export type OtherContentWhereInput = {
  AND?: InputMaybe<Array<OtherContentWhereInput>>;
  NOT?: InputMaybe<Array<OtherContentWhereInput>>;
  OR?: InputMaybe<Array<OtherContentWhereInput>>;
  descriptionEn?: InputMaybe<StringFilter>;
  descriptionHr?: InputMaybe<StringFilter>;
  event?: InputMaybe<CalendarItemNullableRelationFilter>;
  nameEn?: InputMaybe<StringFilter>;
  nameHr?: InputMaybe<StringFilter>;
  participants?: InputMaybe<OtherContentPresenterListRelationFilter>;
  subtype?: InputMaybe<StringFilter>;
};

export type PanelCompanyEntry = {
  company: Company;
  panelists: Array<ApplicationPresenter>;
};
...
export type Query = {
  ...
  internships: Array<ApplicationInternship>;
  internshipsForAdmin: Array<ApplicationInternship>;
  ...
  otherContents: Array<OtherContent>;
  participants: Array<Company>;
  partners: Array<Partner>;
  pressRelease?: Maybe<PressRelease>;
  pressReleases: Array<PressRelease>;
  profile?: Maybe<User>;
  questApplicants: Array<QuestApplicantEntry>;
  questCompanies: Array<Company>;
  questCompaniesWithStats: Array<QuestCompanyStats>;
  resume?: Maybe<Resume>;
...
export type QueryCompanyWantsQuestArgs = {
  companyUid?: InputMaybe<Scalars['String']['input']>;
...
export type QueryInternshipsForAdminArgs = {
  cursor?: InputMaybe<ApplicationInternshipWhereUniqueInput>;
  distinct?: InputMaybe<Array<ApplicationInternshipScalarFieldEnum>>;
  orderBy?: InputMaybe<Array<ApplicationInternshipOrderByWithRelationInput>>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type QueryOtherContentsArgs = {
  season?: InputMaybe<Scalars['String']['input']>;
};
...
export type QueryQuestApplicantsArgs = {
  companyUid: Scalars['String']['input'];
  seasonUid: Scalars['String']['input'];
};


export type QueryQuestCompaniesArgs = {
  seasonUid?: InputMaybe<Scalars['String']['input']>;
};


export type QueryQuestCompaniesWithStatsArgs = {
  seasonUid: Scalars['String']['input'];
};
...
export type QuestApplicantEntry = {
  points: Scalars['Int']['output'];
  scannedAt: Scalars['DateTimeISO']['output'];
  user: User;
};

export type QuestChooseInput = {
  prize: Scalars['String']['input'];
};

export type QuestCompanyStats = {
  applicantCount: Scalars['Int']['output'];
  company: Company;
};

export type QuestScan = {
  eventId: Scalars['Int']['output'];
  eventName: Scalars['String']['output'];
  eventType: Scalars['String']['output'];
  firstScannedAt: Scalars['DateTimeISO']['output'];
  points: Scalars['Int']['output'];
};
...
export type SeasonCountOtherContentsArgs = {
  where?: InputMaybe<OtherContentWhereInput>;
};


export type SeasonCountPanelsArgs = {
  where?: InputMaybe<CompanyPanelWhereInput>;
};
...
export type SyncResult = {
  ...
  unmatched: Array<UnmatchedInternship>;
...
export type UnmatchedInternship = {
  description: Scalars['String']['output'];
...
export type User = {
  ...
  name: Scalars['String']['output'];
  phone: Scalars['String']['output'];
  questAppliedCompanies: Array<Company>;
  questPoints: Scalars['Int']['output'];
  questScans: Array<QuestScan>;
  resume?: Maybe<Resume>;
  roles: Array<Role>;
  uid: Scalars['String']['output'];
  updatedAt: Scalars['DateTimeISO']['output'];
...
export type Frag_UserProfileFragment = { uid: string, name: string, firstName: string, lastName: string, email: string, phone: string, language: string, questPoints: number, roles: Array<{ name: string }>, companies: Array<{ uid: string, vat: string, legalName: string, brandName: string, address: string, website: string, instagram?: string | null, facebook?: string | null, linkedIn?: string | null, descriptionEn: string, descriptionHr: string, industry?: { name: string } | null }>, questScans: Array<{ eventType: string, eventId: number, eventName: string, points: number, firstScannedAt: string | Date }>, questAppliedCompanies: Array<{ uid: string, brandName: string, program?: { quest?: { prize: string } | null } | null }> } & { ' $fragmentName'?: 'Frag_UserProfileFragment' };
...
export type Frag_CompanyApplicationFragment = { booth?: string | null, wantsPanel: boolean, wantsCocktail: boolean, wantsQuest: boolean, contactPerson?: { name: string, email: string, phone: string } | null, talk?: { titleEn: string, titleHr: string, descriptionEn: string, descriptionHr: string, language: string, category: { name: string }, presenters: Array<{ ' $fragmentRefs'?: { 'Frag_ApplicationPresenterFragment': Frag_ApplicationPresenterFragment } }> } | null, workshop?: { titleEn: string, titleHr: string, descriptionEn: string, descriptionHr: string, language: string, goal: string, notesEn: string, notesHr: string, presenters: Array<{ ' $fragmentRefs'?: { 'Frag_ApplicationPresenterFragment': Frag_ApplicationPresenterFragment } }> } | null, fusion?: { titleEn: string, titleHr: string, descriptionEn: string, descriptionHr: string, language: string, category?: { name: string } | null, presenters: Array<{ ' $fragmentRefs'?: { 'Frag_ApplicationPresenterFragment': Frag_ApplicationPresenterFragment } }> } | null, cocktail?: { name: string, type: { type: string } } | null, quest?: { prize: string } | null, internships: Array<{ ' $fragmentRefs'?: { 'Frag_InternshipFragment': Frag_InternshipFragment } }>, panelParticipants: Array<{ ' $fragmentRefs'?: { 'Frag_ApplicationPresenterFragment': Frag_ApplicationPresenterFragment } }>, approval?: { cocktail: boolean, quest: boolean, panel: boolean, talkParticipants: number, workshopParticipants: number, fusionParticipants: number, booth: boolean } | null, feedback?: { ' $fragmentRefs'?: { 'Frag_AllFeedbackFragment': Frag_AllFeedbackFragment } } | null } & { ' $fragmentName'?: 'Frag_CompanyApplicationFragment' };
...
export type Frag_InternshipFragment = { uid: string, position: string, competencies?: string | null, description: string, workingPeriodStart: string | Date, workingPeriodEnd: string | Date, url?: string | null, duration?: string | null, places?: number | null, signed?: boolean | null, company?: { uid: string, brandName: string, rasterLogo?: { fullUrl: string, thumbUrl: string } | null } | null } & { ' $fragmentName'?: 'Frag_InternshipFragment' };
...
export type AdminCompanyApplicationQuery = { talkCategories: Array<{ name: string }>, booths: Array<{ name: string, key?: string | null }>, companyApplicationFor?: (
    { forCompany?: (
      { signatories: Array<{ fullName: string, function: string }> }
      & { ' $fragmentRefs'?: { 'Frag_CompanyFragment': Frag_CompanyFragment } }
    ) | null }
...
export type AdminCompanyApplicationsQuery = { industries: Array<{ name: string }>, talkCategories: Array<{ name: string }>, booths: Array<{ key?: string | null, name: string }>, companyApplications?: Array<{ createdAt: string | Date, wantsCocktail: boolean, wantsPanel: boolean, wantsQuest: boolean, booth?: string | null, talk?: { language: string, titleEn: string, category: { name: string } } | null, cocktail?: { name: string, type: { type: string } } | null, workshop?: { language: string, titleEn: string } | null, fusion?: { language: string, titleEn: string, category?: { name: string } | null } | null, contactPerson?: { name: string, email: string, phone: string } | null, forCompany?: { uid: string, brandName: string, legalName: string, industry?: { name: string } | null, signatories: Array<{ fullName: string, function: string }> } | null, forSeason?: { uid: string } | null }> | null };
...
export type ProfileBaseDataQuery = { questCompanies: Array<{ uid: string, brandName: string, program?: { quest?: { prize: string } | null } | null }>, booths: Array<{ key?: string | null, name: string }>, companyApplication?: { booth?: string | null, wantsPanel: boolean, wantsCocktail: boolean, wantsQuest: boolean, workshop?: { titleEn: string } | null, talk?: { titleEn: string } | null, fusion?: { titleEn: string, category?: { name: string } | null } | null, approval?: { booth: boolean, workshopParticipants: number, talkParticipants: number, fusionParticipants: number, panel: boolean, cocktail: boolean, quest: boolean } | null, userApplications: { workshop: number, talk: number, fusion: number }, internships: Array<{ uid: string, position: string, signed?: boolean | null }> } | null, profile?: { resume?: { uid: string } | null } | null, calendar: Array<{ uid: string, title?: string | null, forWorkshop?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forTalk?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forFusion?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forPanel?: { uid: string, name: string, description: string, reservation: number } | null }>, currentSeason?: (
...
export type PageAdminSeasonScheduleBaseQuery = { participants: Array<{ uid: string, brandName: string, program?: { talk?: { uid: string, event?: { uid: string, type?: string | null, title?: string | null, start: string | Date, end: string | Date, location?: string | null, text?: string | null, grouped: boolean } | null } | null, workshop?: { uid: string, event?: { uid: string, type?: string | null, title?: string | null, start: string | Date, end: string | Date, location?: string | null, text?: string | null, grouped: boolean } | null } | null, fusion?: { uid: string, event?: { uid: string, type?: string | null, title?: string | null, start: string | Date, end: string | Date, location?: string | null, text?: string | null, grouped: boolean } | null } | null, panelParticipants: Array<{ firstName: string, lastName: string, photo?: { fullUrl: string, thumbUrl: string } | null }> } | null }>, season?: { panels: Array<{ uid: string, name: string, description: string, companies: Array<{ uid: string }>, event?: { uid: string, type?: string | null, title?: string | null, start: string | Date, end: string | Date, location?: string | null, text?: string | null, grouped: boolean } | null }>, calendar: Array<{ uid: string, type?: string | null, title?: string | null, start: string | Date, end: string | Date, location?: string | null, text?: string | null, grouped: boolean }> } | null };
...
export type AdminReservationsDataQuery = { season?: { reservations: Array<{ uid: string, type: string, count: number }> } | null, otherContents: Array<{ uid: string, nameHr: string, nameEn: string, subtype: string, event?: { uid: string } | null }>, participants: Array<{ uid: string, vat: string, brandName: string, program?: { workshop?: { uid: string, titleHr: string } | null, talk?: { uid: string, titleHr: string } | null, fusion?: { uid: string, titleHr: string } | null, panel?: { uid: string, name: string } | null } | null }> };
...
export type PageAdminSeasonApplicationsCompanyEdit_UpsertApplicationMutation = { createCompanyApplicationFor?: { entity?: { wantsCocktail: boolean, wantsPanel: boolean, wantsQuest: boolean, talk?: { uid: string } | null, workshop?: { uid: string } | null, fusion?: { uid: string } | null, quest?: { prize: string } | null } | null, errors?: Array<{ field: string, message: string }> | null } | null };
...
export type PageAdminSeasonApplicationsApproval_BaseQuery = { season?: { name: string, startsAt: string | Date, endsAt: string | Date, applications: Array<{ wantsPanel: boolean, wantsCocktail: boolean, wantsQuest: boolean, booth?: string | null, talk?: { titleEn: string, titleHr: string } | null, workshop?: { titleEn: string, titleHr: string } | null, fusion?: { titleEn: string, titleHr: string } | null, forCompany?: { uid: string, legalName: string, brandName: string } | null, approval?: { booth: boolean, talkParticipants: number, workshopParticipants: number, fusionParticipants: number, panel: boolean, cocktail: boolean, quest: boolean, logoHidden: boolean } | null }> } | null };
...
export type PageAdminSeasonApplicationsApproval_ApproveCompanyApplicationsMutation = { approveCompanyApplications: Array<{ booth: boolean, talkParticipants: number, workshopParticipants: number, fusionParticipants: number, panel: boolean, cocktail: boolean, quest: boolean, forApplication: { forCompany?: { uid: string } | null } }> };

export type PageAdminSummerInternshipsApi_DataQueryVariables = Exact<{ [key: string]: never; }>;


export type PageAdminSummerInternshipsApi_DataQuery = { internshipsForAdmin: Array<{ uid: string, position: string, description: string, workingPeriodStart: string | Date, workingPeriodEnd: string | Date, places?: number | null, signed?: boolean | null, externalCompany?: string | null }> };

export type PageAdminSummerInternshipsApi_AppsQueryVariables = Exact<{
  season: Scalars['String']['input'];
}>;


export type PageAdminSummerInternshipsApi_AppsQuery = { companyApplications?: Array<{ forCompany?: { uid: string, brandName: string, legalName: string } | null }> | null };

export type SyncSummerInternshipsMutationVariables = Exact<{
  season: Scalars['String']['input'];
}>;


export type SyncSummerInternshipsMutation = { syncSummerInternships: { createdCompanies: Array<string>, updatedCompanies: Array<string>, deletedCompanies: Array<string>, unmatched: Array<{ externalCompany: string, position: string, description: string, workingPeriodStart: string | Date, workingPeriodEnd: string | Date, places?: number | null, signed?: boolean | null }> } };

export type LinkUnmatchedInternshipMutationVariables = Exact<{
  input: LinkUnmatchedInternshipInput;
}>;


export type LinkUnmatchedInternshipMutation = { linkUnmatchedInternship: { uid: string, externalCompany?: string | null, position: string, workingPeriodStart: string | Date, workingPeriodEnd: string | Date, places?: number | null, signed?: boolean | null, description: string } };
...
export type QuestCompaniesWithStatsForAdminQueryVariables = Exact<{
  seasonUid: Scalars['String']['input'];
}>;


export type QuestCompaniesWithStatsForAdminQuery = { questCompaniesWithStats: Array<{ applicantCount: number, company: { uid: string, brandName: string } }> };

export type QuestApplicantsQueryVariables = Exact<{
  seasonUid: Scalars['String']['input'];
  companyUid: Scalars['String']['input'];
}>;


export type QuestApplicantsQuery = { questApplicants: Array<{ points: number, scannedAt: string | Date, user: { uid: string, name: string, email: string, phone: string } }> };
...
export type PageAdminSeasonRatingsQrCodesDataQuery = { season?: { name: string, startsAt: string | Date, endsAt: string | Date, applications: Array<{ forCompany?: { uid: string, legalName: string, brandName: string } | null, approval?: { booth: boolean, talkParticipants: number, workshopParticipants: number, fusionParticipants: number, panel: boolean } | null }> } | null };
...
export type PageCalendarEventPanelDataQueryVariables = Exact<{
  uid: Scalars['String']['input'];
}>;


export type PageCalendarEventPanelDataQuery = { calendarItem?: { forPanel?: { uid: string, name: string, description: string, reservation: number, companiesWithPanelists: Array<{ company: { uid: string, brandName: string, rasterLogo?: { fullUrl: string, thumbUrl: string } | null }, panelists: Array<{ firstName: string, lastName: string, bioHr: string, bioEn: string, photo?: { fullUrl: string, thumbUrl: string } | null }> }>, event?: { start: string | Date, end: string | Date, location?: string | null } | null } | null } | null };

export type PageCalendarEventOtherContentDataQueryVariables = Exact<{
  uid: Scalars['String']['input'];
}>;


export type PageCalendarEventOtherContentDataQuery = { calendarItem?: { forOtherContent?: { uid: string, nameHr: string, nameEn: string, descriptionHr: string, descriptionEn: string, subtype: string, reservation: number, event?: { start: string | Date, end: string | Date, location?: string | null } | null, participants: Array<{ firstName: string, lastName: string, bioEn: string, bioHr: string, photo?: { fullUrl: string } | null }> } | null } | null };
...
export type PageProfileMeCompanyScanUserQrScanMutation = { scanUserQr?: { isStarred?: boolean | null, alreadyScanned: boolean, note?: string | null, cvSaved: boolean, questEntered: boolean, companyWantsQuest: boolean, deleted: boolean, error?: string | null, user?: { uid: string, name: string, email: string, resume?: { cv?: { url: string } | null } | null } | null } | null };
...
export type PageProfileMeCompanyScanUserQrRefineQrScanMutation = { scanUserQrRefine?: { isStarred?: boolean | null, alreadyScanned: boolean, note?: string | null, cvSaved: boolean, questEntered: boolean, companyWantsQuest: boolean, deleted: boolean, error?: string | null, user?: { uid: string, name: string, email: string, resume?: { cv?: { url: string } | null } | null } | null } | null };
...
export type PageProfileMeCompanyScansListDataQuery = { companyWantsQuest: boolean, scanned: Array<{ note?: string | null, isStarred: boolean, scannedAt: string | Date, user?: { uid: string, name: string, email: string, phone: string, resume?: { cv?: { url: string } | null, faculty?: { name: string, module: string } | null, studyYears: Array<{ studyType: string, studyYear: number }> } | null } | null }>, questApplicants: Array<{ scannedAt: string | Date, user?: { uid: string, name: string, email: string } | null }> };
...
export type PageProfileMeCompanyScansListRefineQrScanMutation = { scanUserQrRefine?: { isStarred?: boolean | null, note?: string | null, deleted: boolean, error?: string | null, user?: { uid: string, name: string, email: string, phone: string, resume?: { cv?: { url: string } | null } | null } | null } | null };

export type PageProfileMeCompanySignup_DataQueryVariables = Exact<{ [key: string]: never; }>;


export type PageProfileMeCompanySignup_DataQuery = { talkCategories: Array<{ name: string }>, booths: Array<{ name: string, key?: string | null }>, companyApplication?: { booth?: string | null, wantsPanel: boolean, wantsCocktail: boolean, wantsQuest: boolean, contactPerson?: { name: string, email: string, phone: string } | null, talk?: { titleEn: string, titleHr: string, descriptionEn: string, descriptionHr: string, language: string, category: { name: string }, presenters: Array<{ firstName: string, lastName: string, bioHr: string, bioEn: string, photo?: { name: string, uid: string, full: { mimeType: string } } | null }> } | null, workshop?: { titleEn: string, titleHr: string, descriptionEn: string, descriptionHr: string, language: string, goal: string, notesEn: string, notesHr: string, presenters: Array<{ firstName: string, lastName: string, bioHr: string, bioEn: string, photo?: { name: string, uid: string, full: { mimeType: string } } | null }> } | null, fusion?: { titleEn: string, titleHr: string, descriptionEn: string, descriptionHr: string, language: string, category?: { name: string } | null, presenters: Array<{ firstName: string, lastName: string, bioHr: string, bioEn: string, photo?: { name: string, uid: string, full: { mimeType: string } } | null }> } | null, forCompany?: { signatories: Array<{ fullName: string, function: string }> } | null } | null };
...
export type PageProfileMeCompanySignup_CreateApplicationMutation = { createCompanyApplication?: { entity?: { wantsCocktail: boolean, wantsPanel: boolean, wantsQuest: boolean, talk?: { uid: string } | null, workshop?: { uid: string } | null, fusion?: { uid: string } | null } | null, errors?: Array<{ field: string, message: string }> | null } | null };
...
export type StoreCalendarEventsAllCalendarFragmentFragment = { uid: string, location?: string | null, start: string | Date, end: string | Date, capacity: number, forWorkshop?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forTalk?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forFusion?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forPanel?: { uid: string, name: string, description: string, reservation: number, companies: Array<{ uid: string, brandName: string }> } | null, forOtherContent?: { uid: string, nameHr: string, nameEn: string, descriptionHr: string, descriptionEn: string, subtype: string, reservation: number } | null, companies?: Array<{ uid: string, brandName: string, rasterLogo?: { fullUrl: string, thumbUrl: string } | null }> | null } & { ' $fragmentName'?: 'StoreCalendarEventsAllCalendarFragmentFragment' };
...
export const PageAdminSummerInternshipsApi_DataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PageAdminSummerInternshipsApi_Data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"internshipsForAdmin"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"workingPeriodStart"}},{"kind":"Field","name":{"kind":"Name","value":"workingPeriodEnd"}},{"kind":"Field","name":{"kind":"Name","value":"places"}},{"kind":"Field","name":{"kind":"Name","value":"signed"}},{"kind":"Field","name":{"kind":"Name","value":"externalCompany"}}]}}]}}]} as unknown as DocumentNode<PageAdminSummerInternshipsApi_DataQuery, PageAdminSummerInternshipsApi_DataQueryVariables>;
export const PageAdminSummerInternshipsApi_AppsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PageAdminSummerInternshipsApi_Apps"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"season"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"companyApplications"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"season"},"value":{"kind":"Variable","name":{"kind":"Name","value":"season"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"forCompany"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"brandName"}},{"kind":"Field","name":{"kind":"Name","value":"legalName"}}]}}]}}]}}]} as unknown as DocumentNode<PageAdminSummerInternshipsApi_AppsQuery, PageAdminSummerInternshipsApi_AppsQueryVariables>;
export const SyncSummerInternshipsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SyncSummerInternships"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"season"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"syncSummerInternships"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"season"},"value":{"kind":"Variable","name":{"kind":"Name","value":"season"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createdCompanies"}},{"kind":"Field","name":{"kind":"Name","value":"updatedCompanies"}},{"kind":"Field","name":{"kind":"Name","value":"deletedCompanies"}},{"kind":"Field","name":{"kind":"Name","value":"unmatched"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"externalCompany"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"workingPeriodStart"}},{"kind":"Field","name":{"kind":"Name","value":"workingPeriodEnd"}},{"kind":"Field","name":{"kind":"Name","value":"places"}},{"kind":"Field","name":{"kind":"Name","value":"signed"}}]}}]}}]}}]} as unknown as DocumentNode<SyncSummerInternshipsMutation, SyncSummerInternshipsMutationVariables>;
export const LinkUnmatchedInternshipDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"LinkUnmatchedInternship"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"LinkUnmatchedInternshipInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"linkUnmatchedInternship"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"externalCompany"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"workingPeriodStart"}},{"kind":"Field","name":{"kind":"Name","value":"workingPeriodEnd"}},{"kind":"Field","name":{"kind":"Name","value":"places"}},{"kind":"Field","name":{"kind":"Name","value":"signed"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<LinkUnmatchedInternshipMutation, LinkUnmatchedInternshipMutationVariables>;
...
export const QuestCompaniesWithStatsForAdminDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"QuestCompaniesWithStatsForAdmin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"questCompaniesWithStats"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"seasonUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"company"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"brandName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"applicantCount"}}]}}]}}]} as unknown as DocumentNode<QuestCompaniesWithStatsForAdminQuery, QuestCompaniesWithStatsForAdminQueryVariables>;
export const QuestApplicantsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"QuestApplicants"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"companyUid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"questApplicants"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"seasonUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}}},{"kind":"Argument","name":{"kind":"Name","value":"companyUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"companyUid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"phone"}}]}},{"kind":"Field","name":{"kind":"Name","value":"points"}},{"kind":"Field","name":{"kind":"Name","value":"scannedAt"}}]}}]}}]} as unknown as DocumentNode<QuestApplicantsQuery, QuestApplicantsQueryVariables>;
...
export const PageCalendarEventPanelDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PageCalendarEventPanelData"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"uid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"calendarItem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"uid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"uid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"forPanel"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"reservation"}},{"kind":"Field","name":{"kind":"Name","value":"companiesWithPanelists"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"company"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"brandName"}},{"kind":"Field","name":{"kind":"Name","value":"rasterLogo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fullUrl"}},{"kind":"Field","name":{"kind":"Name","value":"thumbUrl"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"panelists"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"bioHr"}},{"kind":"Field","name":{"kind":"Name","value":"bioEn"}},{"kind":"Field","name":{"kind":"Name","value":"photo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fullUrl"}},{"kind":"Field","name":{"kind":"Name","value":"thumbUrl"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"event"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}},{"kind":"Field","name":{"kind":"Name","value":"location"}}]}}]}}]}}]}}]} as unknown as DocumentNode<PageCalendarEventPanelDataQuery, PageCalendarEventPanelDataQueryVariables>;
export const PageCalendarEventOtherContentDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PageCalendarEventOtherContentData"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"uid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"calendarItem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"uid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"uid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"forOtherContent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"nameHr"}},{"kind":"Field","name":{"kind":"Name","value":"nameEn"}},{"kind":"Field","name":{"kind":"Name","value":"descriptionHr"}},{"kind":"Field","name":{"kind":"Name","value":"descriptionEn"}},{"kind":"Field","name":{"kind":"Name","value":"subtype"}},{"kind":"Field","name":{"kind":"Name","value":"reservation"}},{"kind":"Field","name":{"kind":"Name","value":"event"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}},{"kind":"Field","name":{"kind":"Name","value":"location"}}]}},{"kind":"Field","name":{"kind":"Name","value":"participants"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"bioEn"}},{"kind":"Field","name":{"kind":"Name","value":"bioHr"}},{"kind":"Field","name":{"kind":"Name","value":"photo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fullUrl"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<PageCalendarEventOtherContentDataQuery, PageCalendarEventOtherContentDataQueryVariables>;
...
export const PageProfileMeCompanyScansListDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PageProfileMeCompanyScansListData"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"companyUid"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"scanned"},"name":{"kind":"Name","value":"scannedUsers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"companyUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"companyUid"}}},{"kind":"Argument","name":{"kind":"Name","value":"seasonUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}}},{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"EnumValue","value":"Cv"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"phone"}},{"kind":"Field","name":{"kind":"Name","value":"resume"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cv"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"faculty"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"module"}}]}},{"kind":"Field","name":{"kind":"Name","value":"studyYears"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"studyType"}},{"kind":"Field","name":{"kind":"Name","value":"studyYear"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"isStarred"}},{"kind":"Field","name":{"kind":"Name","value":"scannedAt"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"questApplicants"},"name":{"kind":"Name","value":"scannedUsers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"companyUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"companyUid"}}},{"kind":"Argument","name":{"kind":"Name","value":"seasonUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}}},{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"EnumValue","value":"Quest"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}},{"kind":"Field","name":{"kind":"Name","value":"scannedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"companyWantsQuest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"companyUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"companyUid"}}},{"kind":"Argument","name":{"kind":"Name","value":"seasonUid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seasonUid"}}}]}]}}]} as unknown as DocumentNode<PageProfileMeCompanyScansListDataQuery, PageProfileMeCompanyScansListDataQueryVariables>;

...
export type ApplicationCocktail = {
  _count?: Maybe<ApplicationCocktailCount>;
  colour: Scalars['String']['output'];
  forApplication: Array<CompanyApplication>;
  name: Scalars['String']['output'];
};

export type ApplicationCocktailCount = {
...
export type CompanyApplicationApprovalWhereInput = {
  AND?: InputMaybe<Array<CompanyApplicationApprovalWhereInput>>;
  NOT?: InputMaybe<Array<CompanyApplicationApprovalWhereInput>>;
  OR?: InputMaybe<Array<CompanyApplicationApprovalWhereInput>>;
  booth?: InputMaybe<BoolFilter>;
  cocktail?: InputMaybe<BoolFilter>;
  logoHidden?: InputMaybe<BoolFilter>;
  panel?: InputMaybe<BoolFilter>;
  talkParticipants?: InputMaybe<IntFilter>;
  workshopParticipants?: InputMaybe<IntFilter>;
};

export type CompanyApplicationApprovedEditInput = {
  cocktail?: InputMaybe<CocktailCreateInput>;
...
export type ValidateVatMutation = { validateVat: { valid: boolean, exists: boolean, info?: { address: string, legalName: string } | null } };
...
export type CreateCompanyApplicationMutationVariables = Exact<{
  info: CompanyApplicationCreateInput;
}>;


export type CreateCompanyApplicationMutation = { createCompanyApplication?: { entity?: { wantsCocktail: boolean, wantsPanel: boolean, talk?: { uid: string } | null, workshop?: { uid: string } | null } | null, errors?: Array<{ field: string, message: string }> | null } | null };
...
export type AdminCreateCompanyApplicationMutationVariables = Exact<{
  company: Scalars['String']['input'];
  season: Scalars['String']['input'];
  info: CompanyApplicationCreateInput;
}>;
...
export type AdminCreateCompanyApplicationMutation = { createCompanyApplicationFor?: { entity?: { wantsCocktail: boolean, wantsPanel: boolean, talk?: { uid: string } | null, workshop?: { uid: string } | null } | null, errors?: Array<{ field: string, message: string }> | null } | null };
...
export type PageIndexDataQuery = { sponsors: Array<{ name: string, url: string, photo?: { thumbUrl: string, fullUrl: string } | null }>, partners: Array<{ name: string, url: string, photo?: { thumbUrl: string, fullUrl: string } | null }>, news: Array<{ ' $fragmentRefs'?: { 'Frag_NewsFragment': Frag_NewsFragment } }> };
...
export type AdminCompanyApplicationsQuery = { industries: Array<{ name: string }>, talkCategories: Array<{ name: string }>, booths: Array<{ key?: string | null, name: string }>, companyApplications?: Array<{ wantsCocktail: boolean, wantsPanel: boolean, booth?: string | null, talk?: { language: string, titleEn: string, category: { name: string } } | null, workshop?: { language: string, titleEn: string } | null, forCompany?: { uid: string, brandName: string, industry?: { name: string } | null } | null, forSeason?: { uid: string } | null }> | null };

export type CurrentCompanyApplicationQueryVariables = Exact<{ [key: string]: never; }>;


export type CurrentCompanyApplicationQuery = { talkCategories: Array<{ name: string }>, booths: Array<{ name: string, key?: string | null }>, companyApplication?: { ' $fragmentRefs'?: { 'Frag_CompanyApplicationFragment': Frag_CompanyApplicationFragment } } | null };
...
export type PageParticipants_BaseQuery = { participants: Array<{ uid: string, website: string, brandName: string, descriptionEn: string, descriptionHr: string, logoHidden: boolean, rasterLogo?: { thumbUrl: string, fullUrl: string } | null }> };
...
export type PageProfileMeCompanyScanUserQrScanMutation = { scanUserQr?: { isStarred?: boolean | null, alreadyScanned: boolean, note?: string | null, error?: string | null, user?: { uid: string, name: string, email: string } | null } | null };
...
export type PageProfileMeCompanyScanUserQrRefineQrScanMutation = { scanUserQrRefine?: { isStarred?: boolean | null, note?: string | null, error?: string | null, user?: { uid: string, name: string, email: string } | null } | null };
...
export const CreateCompanyApplicationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCompanyApplication"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"info"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CompanyApplicationCreateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCompanyApplication"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"info"},"value":{"kind":"Variable","name":{"kind":"Name","value":"info"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"entity"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"talk"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}}]}},{"kind":"Field","name":{"kind":"Name","value":"workshop"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}}]}},{"kind":"Field","name":{"kind":"Name","value":"wantsCocktail"}},{"kind":"Field","name":{"kind":"Name","value":"wantsPanel"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<CreateCompanyApplicationMutation, CreateCompanyApplicationMutationVariables>;
...
export const AdminCreateCompanyApplicationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AdminCreateCompanyApplication"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"company"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"season"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"info"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CompanyApplicationCreateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCompanyApplicationFor"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"company"},"value":{"kind":"Variable","name":{"kind":"Name","value":"company"}}},{"kind":"Argument","name":{"kind":"Name","value":"season"},"value":{"kind":"Variable","name":{"kind":"Name","value":"season"}}},{"kind":"Argument","name":{"kind":"Name","value":"info"},"value":{"kind":"Variable","name":{"kind":"Name","value":"info"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"entity"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"talk"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}}]}},{"kind":"Field","name":{"kind":"Name","value":"workshop"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}}]}},{"kind":"Field","name":{"kind":"Name","value":"wantsCocktail"}},{"kind":"Field","name":{"kind":"Name","value":"wantsPanel"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<AdminCreateCompanyApplicationMutation, AdminCreateCompanyApplicationMutationVariables>;

...
export type PageParticipants_BaseQuery = { participants: Array<{ uid: string, website: string, brandName: string, descriptionEn: string, descriptionHr: string, logoHidden: boolean, rasterLogo?: { thumbUrl: string, fullUrl: string } | null, ratings: Array<{ averageRating: number, component: string }> }> };

export type PageParticipants_RatingsQueryVariables = Exact<{ [key: string]: never; }>;


export type PageParticipants_RatingsQuery = { participants: Array<{ uid: string, brandName: string, ratings: Array<{ averageRating: number, component: string }> }> };

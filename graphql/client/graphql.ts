...
export type AdminCompanyApplicationsQuery = { industries: Array<{ name: string }>, talkCategories: Array<{ name: string }>, booths: Array<{ key?: string | null, name: string }>, companyApplications?: Array<{ wantsCocktail: boolean, wantsPanel: boolean, wantsQuest: boolean, booth?: string | null, talk?: { language: string, titleEn: string, category: { name: string } } | null, cocktail?: { name: string, type: { type: string } } | null, workshop?: { language: string, titleEn: string } | null, forCompany?: { uid: string, brandName: string, legalName: string, industry?: { name: string } | null } | null, forSeason?: { uid: string } | null }> | null };
...
export type ProfileBaseDataQuery = { booths: Array<{ key?: string | null, name: string }>, companyApplication?: { booth?: string | null, wantsPanel: boolean, wantsCocktail: boolean, wantsQuest: boolean, workshop?: { titleEn: string } | null, talk?: { titleEn: string } | null, approval?: { booth: boolean, workshopParticipants: number, talkParticipants: number, panel: boolean, cocktail: boolean, quest: boolean } | null, userApplications: { workshop: number, talk: number }, internship?: { position: string } | null } | null, profile?: { resume?: { uid: string } | null } | null, calendar: Array<{ uid: string, title?: string | null, forWorkshop?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forTalk?: { uid: string, titleHr: string, titleEn: string, descriptionHr: string, descriptionEn: string, reservation: number } | null, forPanel?: { uid: string, name: string, description: string, reservation: number } | null }>, currentSeason?: (
...
export type PageAdminSeasonApplicationsCompanyEdit_UpsertApplicationMutation = { createCompanyApplicationFor?: { entity?: { wantsCocktail: boolean, wantsPanel: boolean, wantsQuest: boolean, talk?: { uid: string } | null, workshop?: { uid: string } | null } | null, errors?: Array<{ field: string, message: string }> | null } | null };
...
export type PageAdminSeasonApplicationsApproval_BaseQuery = { season?: { name: string, startsAt: string | Date, endsAt: string | Date, applications: Array<{ wantsPanel: boolean, wantsCocktail: boolean, wantsQuest: boolean, booth?: string | null, talk?: { titleEn: string, titleHr: string } | null, workshop?: { titleEn: string, titleHr: string } | null, forCompany?: { uid: string, legalName: string, brandName: string } | null, approval?: { booth: boolean, talkParticipants: number, workshopParticipants: number, panel: boolean, cocktail: boolean, quest: boolean, logoHidden: boolean } | null }> } | null };
...
export type PageAdminSeasonApplicationsApproval_ApproveCompanyApplicationsMutation = { approveCompanyApplications: Array<{ booth: boolean, talkParticipants: number, workshopParticipants: number, panel: boolean, cocktail: boolean, quest: boolean, forApplication: { forCompany?: { uid: string } | null } }> };
...
export type PageProfileMeCompanySignup_CreateApplicationMutation = { createCompanyApplication?: { entity?: { wantsCocktail: boolean, wantsPanel: boolean, wantsQuest: boolean, talk?: { uid: string } | null, workshop?: { uid: string } | null } | null, errors?: Array<{ field: string, message: string }> | null } | null };

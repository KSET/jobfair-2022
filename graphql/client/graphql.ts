...
export type PageAdminSeasonApplicationsCompanyEdit_UpsertApplicationMutation = { createCompanyApplicationFor?: { entity?: { wantsCocktail: boolean, wantsPanel: boolean, wantsQuest: boolean, talk?: { uid: string } | null, workshop?: { uid: string } | null, fusion?: { uid: string } | null } | null, errors?: Array<{ field: string, message: string }> | null } | null };
...
export type PageProfileMeCompanyScanUserQrScanMutation = { scanUserQr?: { isStarred?: boolean | null, alreadyScanned: boolean, note?: string | null, error?: string | null, user?: { uid: string, name: string, email: string, resume?: { cv?: { url: string } | null } | null } | null } | null };
...
export type PageProfileMeCompanyScanUserQrRefineQrScanMutation = { scanUserQrRefine?: { isStarred?: boolean | null, note?: string | null, error?: string | null, user?: { uid: string, name: string, email: string, resume?: { cv?: { url: string } | null } | null } | null } | null };
...
export type PageProfileMeCompanyScansListDataQuery = { scannedUsers: Array<{ note?: string | null, isStarred: boolean, scannedAt: string | Date, user?: { uid: string, name: string, email: string, phone: string, resume?: { cv?: { url: string } | null, faculty?: { name: string, module: string } | null, studyYears: Array<{ studyType: string, studyYear: number }> } | null } | null }> };
...
export type PageProfileMeCompanyScansListRefineQrScanMutation = { scanUserQrRefine?: { isStarred?: boolean | null, note?: string | null, error?: string | null, user?: { uid: string, name: string, email: string, phone: string, resume?: { cv?: { url: string } | null } | null } | null } | null };
